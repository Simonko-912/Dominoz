"""
Dominoes Server (prototype) for demo server for github (using render)
...
# --- Run server (headless for Render) ---
if __name__ == "__main__":
    ...
    server_name = os.environ.get("SERVER_NAME", "DominoServer")
    max_players_per_lobby = int(os.environ.get("MAX_PLAYERS", 4))
    max_lobbies = int(os.environ.get("MAX_LOBBIES", 4))
    difficulty = os.environ.get("DIFFICULTY", "normal").lower()
